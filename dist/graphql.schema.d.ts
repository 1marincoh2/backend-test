export declare enum CityModelSortFields {
    _id = "_id"
}
export declare enum PreferenceModelSortFields {
    _id = "_id"
}
...
export declare class CityModelDeleteFilter {
    _id?: Nullable<IDFilterComparison>;
    and?: Nullable<CityModelDeleteFilter[]>;
    or?: Nullable<CityModelDeleteFilter[]>;
}
export declare class CityModelFilter {
    _id?: Nullable<IDFilterComparison>;
    and?: Nullable<CityModelFilter[]>;
    or?: Nullable<CityModelFilter[]>;
}
export declare class CityModelSort {
    direction: SortDirection;
    field: CityModelSortFields;
    nulls?: Nullable<SortNulls>;
}
export declare class CityModelUpdateFilter {
    _id?: Nullable<IDFilterComparison>;
    and?: Nullable<CityModelUpdateFilter[]>;
    or?: Nullable<CityModelUpdateFilter[]>;
}
export declare class CreateCityModel {
    _id?: Nullable<string>;
    city?: Nullable<string>;
    region?: Nullable<string>;
    regionCode?: Nullable<number>;
}
export declare class CreateManyCityModelsInput {
    cityModels: CreateCityModel[];
}
export declare class CreateManyPreferenceModelsInput {
    preferenceModels: CreatePreferenceModel[];
}
export declare class CreateOneCityModelInput {
    cityModel: CreateCityModel;
}
export declare class CreateOnePreferenceModelInput {
    preferenceModel: CreatePreferenceModel;
}
export declare class CreatePreferenceModel {
    _id?: Nullable<string>;
    active?: Nullable<boolean>;
    name?: Nullable<string>;
}
export declare class CursorPaging {
    after?: Nullable<ConnectionCursor>;
    before?: Nullable<ConnectionCursor>;
    first?: Nullable<number>;
    last?: Nullable<number>;
}
export declare class DeleteManyCityModelsInput {
    filter: CityModelDeleteFilter;
}
export declare class DeleteManyPreferenceModelsInput {
    filter: PreferenceModelDeleteFilter;
}
export declare class DeleteOneCityModelInput {
    id: string;
}
export declare class DeleteOnePreferenceModelInput {
    id: string;
}
export declare class IDFilterComparison {
    eq?: Nullable<string>;
    gt?: Nullable<string>;
    gte?: Nullable<string>;
...
export declare class PreferenceModelDeleteFilter {
    _id?: Nullable<IDFilterComparison>;
    and?: Nullable<PreferenceModelDeleteFilter[]>;
    or?: Nullable<PreferenceModelDeleteFilter[]>;
}
export declare class PreferenceModelFilter {
    _id?: Nullable<IDFilterComparison>;
    and?: Nullable<PreferenceModelFilter[]>;
    or?: Nullable<PreferenceModelFilter[]>;
}
export declare class PreferenceModelSort {
    direction: SortDirection;
    field: PreferenceModelSortFields;
    nulls?: Nullable<SortNulls>;
}
export declare class PreferenceModelUpdateFilter {
    _id?: Nullable<IDFilterComparison>;
    and?: Nullable<PreferenceModelUpdateFilter[]>;
    or?: Nullable<PreferenceModelUpdateFilter[]>;
}
export declare class UpdateCityModel {
    _id?: Nullable<string>;
    city?: Nullable<string>;
    region?: Nullable<string>;
    regionCode?: Nullable<number>;
}
export declare class UpdateManyCityModelsInput {
    filter: CityModelUpdateFilter;
    update: UpdateCityModel;
}
export declare class UpdateManyPreferenceModelsInput {
    filter: PreferenceModelUpdateFilter;
    update: UpdatePreferenceModel;
}
export declare class UpdateOneCityModelInput {
    id: string;
    update: UpdateCityModel;
}
export declare class UpdateOnePreferenceModelInput {
    id: string;
    update: UpdatePreferenceModel;
}
export declare class UpdatePreferenceModel {
    _id?: Nullable<string>;
    active?: Nullable<boolean>;
    name?: Nullable<string>;
}
...
export declare class CityModelAggregateGroupBy {
    _id?: Nullable<string>;
}
export declare class CityModelConnection {
    edges: CityModelEdge[];
    pageInfo: PageInfo;
}
export declare class CityModelCountAggregate {
    _id?: Nullable<number>;
}
export declare class CityModelDeleteResponse {
    _id?: Nullable<string>;
    city?: Nullable<string>;
    region?: Nullable<string>;
    regionCode?: Nullable<number>;
}
export declare class CityModelEdge {
    cursor: ConnectionCursor;
    node: CityModel;
}
export declare class CityModelMaxAggregate {
    _id?: Nullable<string>;
}
export declare class CityModelMinAggregate {
    _id?: Nullable<string>;
}
export declare class DeleteManyResponse {
    deletedCount: number;
}
...
export declare class PreferenceModel {
    _id: string;
    active: boolean;
    name: string;
}
export declare class PreferenceModelAggregateGroupBy {
    _id?: Nullable<string>;
}
export declare class PreferenceModelConnection {
    edges: PreferenceModelEdge[];
    pageInfo: PageInfo;
}
export declare class PreferenceModelCountAggregate {
    _id?: Nullable<number>;
}
export declare class PreferenceModelDeleteResponse {
    _id?: Nullable<string>;
    active?: Nullable<boolean>;
    name?: Nullable<string>;
}
export declare class PreferenceModelEdge {
    cursor: ConnectionCursor;
    node: PreferenceModel;
}
export declare class PreferenceModelMaxAggregate {
    _id?: Nullable<string>;
}
export declare class PreferenceModelMinAggregate {
    _id?: Nullable<string>;
}
...
export declare class UpdateManyResponse {
    updatedCount: number;
}
export declare type ConnectionCursor = any;
