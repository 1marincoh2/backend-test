...
SucursalModule = __decorate([
    common_1.Module({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: sucursal_schema_1.Sucursal.name, schema: sucursal_schema_1.SucursalSchema }]),
        ],
...
//# sourceMappingURL=clasification.module.js.map